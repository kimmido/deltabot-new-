    ...
    <div>
        ...
        <p className="intro-desc">
          <p>
            ...
            <span className="highlight">
              제조 데이터의 투명성과 실시간 공유 체계를 구축
            </span>
            하여&nbsp;
            <span className="highlight">
              현장 이슈에 골든 타임 내 민첩하게 대응
            </span>
            하고,
          </p>
          <p>
            이를 통해&nbsp;
            <span className="highlight">
              생산성 향상, 비용 절감, 품질 혁신, 그리고 지속 가능한 성장
            </span>
            을 이끄는&nbsp;
            <span className="highlight">
              스마트팩토리의 굳건한 미래를 위한 초석
            </span>
            이 됩니다!
          </p>
        </p>
      ...
      <section className="section cnt02 container">
        ...
        <p className="cnt-desc">
          <p>
            스마트 공장은 AI, 빅데이터, IoT와 같은 첨단 ICT 기술을 활용하여 제품
            기획부터 판매에 이르는 모든 생산 과정을 통합하고 지능화한 첨단
            지능형 공장을 의미합니다.
          </p>
          <p>
            이러한 시스템은 산업용 로봇을 지능적으로 운영하며, 
            <span className="highlight">
              최소 비용과 시간으로 고객 맞춤형 제품을 유연하게 생산하는 것
            </span>
            을 목표로 합니다.
          </p>
        </p>
      ...
      <section className="section cnt04 container">
        ...
        <h4 className="sub-title">주요 시스템의 역할과 구성</h4>
        <img className="card" src={img03} alt="스마트팩토리 공정도" />
        <p>
          <p>
            로봇 데이터를 가장 효율적으로 수집·가공하는 저희만의 독자적인
            솔루션을 제공하여, 반복 작업을 자동화하고, 로봇 프로그램 설계부터
            현장 적용까지 걸리는 시간을 크게 줄여드립니다.
          </p>
          <p>
            스마트 팩토리 환경에 꼭 맞는 생산 로봇 시스템을 제공하여, 로봇
            운영과 센서에서 나오는 다양한 데이터를 엣지/클라우드 환경에서 실시간
            통합 분석하고 있습니다. 이러한 데이터 분석을 토대로, AI 기반 지능형
            최적화 및 제어 알고리즘을 적용해 예지 정비 및 불량 예측 기능을
            체계적으로 구축하고 있습니다. 더불어, 스마트 팩토리의 핵심
            시스템들과도 자연스럽게 연결되어 생산 공정의 자율성과 품질의
            일관성을 높이고 있습니다.
          </p>
        </p>
      </section>
      ...
      <section className="section cnt05">
        <div className="container">
          ...
          <div>
            <h4 className="sub-title">도입 단계별 로드맵</h4>
