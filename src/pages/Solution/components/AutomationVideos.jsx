...
function AutomationVideos() {
  const videos = [
    ...
    },
    {
      ...
      videoSrc: "https://www.youtube.com/embed/liWY_VqCZgg?si=yKR-EUIw0_vHhaau",
      effects: [
        {
    ...
    },
    {
      ...
      videoSrc: "https://www.youtube.com/embed/dX01GxBY1ZQ?si=iha1S-MeJJjSA1dj",
      effects: [
        {
          title: "분당 160개 처리",
          iconName: "timer",
            ...
            <ul className="effect-list">
              {item.effects.map((effect) => (
                <li>
                  <div className="icon">
                    <img
                      src={`/image/icon/${effect.iconName}.png`}
                      alt={`${effect.iconName}`}
                    />
                  </div>
                  <h5>{effect.title}</h5>
              ...
              {item.steps.map((step, idx) => (
                <li>
                  <div className="step__icon-box">
                    <img
                      src={`/image/icon/${step.iconName}.png`}
                      alt={`${step.iconName}`}
                    />
                    <p>0{idx + 1}</p>
                  </div>
